 ...
 * @num_domain_opps_get: gets number of opps for a given domain
 ...
 * @domain_freqs_get: gets all possible frequencies for a given domain
 *
 */
struct scmi_perf_ops {
	...
	int (*device_opps_add)(const struct scmi_handle *handle,
			       struct device *dev);
	int (*num_domain_opps_get)(const struct scmi_handle *handle, u32 domain,
				   u32 *num_opps);
	...
	int (*domain_freqs_get)(const struct scmi_handle *handle, u32 domain,
				u32 *rates_khz);
};
